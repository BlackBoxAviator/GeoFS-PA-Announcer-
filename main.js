(function () {
  if (document.getElementById('pa-overlay')) {
    document.getElementById('pa-overlay').remove();
    document.getElementById('pa-toast') && document.getElementById('pa-toast').remove();
    document.getElementById('pa-style') && document.getElementById('pa-style').remove();
    document.getElementById('pa-fonts') && document.getElementById('pa-fonts').remove();
    return;
  }
  ...
  // ── Keyboard (no textarea to worry about)
